      ...
      >
        <div className="hero-text text-center text-[#f1d832] z-30 max-w-4xl px-6">
          ...
          <p className="description text-base sm:text-lg mb-8 px-4 animate__animated animate__fadeIn animate__delay-2s">
            Fort de plus de 30 ans d'expérience dans le domaine de
            l'électricité, Jacques Pinard intervient à Rennes et dans ses
            alentours pour vous fournir des services électriques de qualité, en
            toute sécurité. Vous pouvez compter sur lui pour tous vos projets
            électriques, qu'il s'agisse d'une rénovation, d'une nouvelle
            installation ou d'un dépannage urgent.
          </p>
