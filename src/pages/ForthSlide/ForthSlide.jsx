...
export default function ForthSlide() {
  ...
  return (
    <>
      <Helmet>
        <title>Contactez Jacquelec - Électricien à Rennes</title>
        <meta
          name="description"
          content="Contactez Jacques Pinard, électricien à Rennes, pour un devis gratuit, dépannage électrique ou toute question sur vos installations électriques."
        />
        <meta
          name="keywords"
